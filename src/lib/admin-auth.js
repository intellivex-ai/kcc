...
// 🛡️ Sentinel: Hardcoded fallback values (e.g., || 'kcc2024') were removed to prevent
// exposing critical admin credentials in the public client-side JavaScript bundle.
