...
// 🛡️ Sentinel: Removed hardcoded fallback credentials to prevent unauthorized access if env vars are missing.
// Using a secure random fallback ensures the app fails securely if misconfigured.
