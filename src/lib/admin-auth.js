...
// Get credentials from environment variables securely without embedding fallback secrets
const ADMIN_CREDENTIALS = {
    username: import.meta.env.VITE_ADMIN_USERNAME || undefined,
    password: import.meta.env.VITE_ADMIN_PASSWORD || undefined
};
