...
// 🛡️ Sentinel: Removed hardcoded fallback credentials to prevent unauthorized bypass
...
export const login = (username, password) => {
    // 🛡️ Sentinel: Fail securely if credentials are not configured
...
export const changePassword = (oldPassword, newPassword) => {
    ...
    // 🛡️ Sentinel: Using correct ADMIN_CREDENTIALS reference
