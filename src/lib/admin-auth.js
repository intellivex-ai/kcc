...
// Security: Use crypto.randomUUID() as a fallback to ensure the app fails securely if env vars are missing, rather than allowing access with known default credentials.
