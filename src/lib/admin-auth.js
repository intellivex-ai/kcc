...
// Security: Use crypto.randomUUID() as a fallback to ensure the application fails securely without exposing a known backdoor if environment variables are missing.
