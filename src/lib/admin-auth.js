...
// 🛡️ Sentinel: Removed hardcoded password fallback to prevent unauthorized access
// Generate a safe fallback to prevent crashes but ensure authentication fails safely
