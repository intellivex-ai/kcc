...
// 🛡️ Sentinel: Removed hardcoded fallback credentials to prevent unauthorized access if env variables are missing. Using secure random fallback to fail securely.
