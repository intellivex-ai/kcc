...
// Helper to generate a safe random string fallback
...
const ADMIN_CREDENTIALS = {
    username: import.meta.env.VITE_ADMIN_USERNAME || getSafeFallback(),
    // 🛡️ Sentinel: Removed hardcoded password fallback to prevent trivial unauthorized access
    password: import.meta.env.VITE_ADMIN_PASSWORD || getSafeFallback()
};
