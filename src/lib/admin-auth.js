...
// SECURITY: Removed hardcoded fallback credentials to prevent unauthorized bypass
...
export const login = (username, password) => {
    // SECURITY: Fail securely if admin credentials are not properly configured
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        console.error('Security Error: Admin credentials are not configured in environment variables.');
