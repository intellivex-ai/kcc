...
// SECURITY: Fail securely if credentials are missing. Hardcoded fallbacks removed.
...
export const login = (username, password) => {
    // SECURITY: Disallow login if credentials are not configured in environment
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        return { success: false, error: 'Authentication system is not properly configured' };
    }
