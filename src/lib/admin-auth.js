...
export const login = (username, password) => {
    // Fail securely if no credentials are set in environment
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        console.error('Admin authentication requires environment variables VITE_ADMIN_USERNAME and VITE_ADMIN_PASSWORD to be configured.');
