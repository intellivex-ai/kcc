...
export const login = (username, password) => {
    // Fail securely if server is misconfigured
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        console.error('Server not configured securely: Admin credentials missing.');
        return { success: false, error: 'System error. Please contact administrator.' };
    }
