...
const ADMIN_CREDENTIALS = {
    ...
    password: import.meta.env.VITE_ADMIN_PASSWORD // 🛡️ Sentinel: Removed hardcoded password fallback
};
...
export const login = (username, password) => {
    // 🛡️ Sentinel: Fail securely if password isn't configured in environment
    if (!ADMIN_CREDENTIALS.password) {
        return { success: false, error: 'Admin credentials not configured securely' };
    }
