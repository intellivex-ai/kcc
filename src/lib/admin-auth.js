...
// Security: Use crypto.randomUUID() as fallback to ensure the application fails securely
// with unguessable credentials rather than allowing a known backdoor if env vars are missing.
