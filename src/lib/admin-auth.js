...
export const login = (username, password) => {
    // Security check: Ensure credentials are provided in environment
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        console.error('🛡️ Sentinel: Admin credentials are not configured.');
        return { success: false, error: 'Authentication is unavailable. Please check system configuration.' };
    }
