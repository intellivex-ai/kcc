...
// 🛡️ Sentinel: Removed fallback string literals to prevent them from being permanently embedded in Vite's public client-side build outputs
...
export const login = (username, password) => {
    // 🛡️ Sentinel: Secure failure state if environment variables are missing
    if (!ADMIN_CREDENTIALS.username || !ADMIN_CREDENTIALS.password) {
        console.error('Admin authentication is not properly configured.');
...
export const changePassword = (oldPassword, _newPassword) => {
