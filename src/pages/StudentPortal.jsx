                            ...
                            <div className="space-y-3">
                                {documents.map((doc, index) => (
                                    <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                        ...
                                        <button aria-label={`Download ${doc.name}`} className="p-2 hover:bg-primary/10 rounded-lg text-primary focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
                                            <Download size={18} />
                                        </button>
                                    </div>
                                ))}
