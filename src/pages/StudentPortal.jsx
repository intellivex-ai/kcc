                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full p-1"
                                    >
            ...
            <div className="bg-white border-b sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <button aria-label="Notifications" className="p-2 hover:bg-gray-100 rounded-lg relative focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                            <Bell size={20} />
                            <span className="absolute top-1 right-1 w-2 h-2 bg-red-600 rounded-full"></span>
                        </button>
                        <button aria-label="Settings" className="p-2 hover:bg-gray-100 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                            <Settings size={20} />
                        </button>
                        <button
                            ...
                            <div className="space-y-3">
                                {documents.map((doc, index) => (
                                    <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                        ...
                                        <button aria-label={`Download ${doc.name}`} className="p-2 hover:bg-primary/10 rounded-lg text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                                            <Download size={18} />
                                        </button>
                                    </div>
                                ))}
