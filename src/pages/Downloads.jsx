...
const Downloads = () => {
    ...
    // 1. Wrapped filter logic in useMemo to prevent unnecessary recalculation on every render
    // 2. Hoisted searchTerm.toLowerCase() outside the filter loop to avoid O(N) redundant string operations
