...
const AlumniNetwork = () => {
    ...
    // ⚡ Bolt: Optimizing filtering performance by hoisting `searchTerm.toLowerCase()`
    // outside the filter loop and memoizing the result to prevent unnecessary re-computations on every render.
