...
const AlumniNetwork = () => {
    ...
    // ⚡ Bolt: Cached expensive set derivations so they aren't recreated every render
    ...
    // ⚡ Bolt: Memoized filtering logic and hoisted the search term lowercasing outside the loop
