...
const AlumniNetwork = () => {
    ...
    // ⚡ Bolt: Cache static arrays to prevent O(N) Set operations on every render (e.g. keystrokes)
    ...
    // ⚡ Bolt: Memoize filtering and hoist toLowerCase() outside the loop to reduce CPU cycles
