...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Hoisted searchTerm.toLowerCase() outside the filter loop and memoized the result to prevent redundant string transformations on every render
    const filteredJobs = useMemo(() => {
        const lowerCaseSearchTerm = searchTerm.toLowerCase();
        return jobListings.filter(job => {
            const matchesSearch = job.title.toLowerCase().includes(lowerCaseSearchTerm) ||
