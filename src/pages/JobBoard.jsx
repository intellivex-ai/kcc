...
const JobBoard = () => {
    ...
    // Bolt: Memoized the filtered jobs array and extracted searchTerm.toLowerCase() outside the filter loop
    // to prevent redundant calculations and unnecessary re-renders when other state changes.
