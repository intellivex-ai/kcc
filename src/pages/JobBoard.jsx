...
const JobBoard = () => {
    ...
    // ⚡ Bolt Performance Optimization: Memoize the filtered jobs list
    // This prevents expensive O(N) array filtering and string operations
    // from running on every component re-render. It only re-calculates
    // when the search term, category filter, or type filter changes.
