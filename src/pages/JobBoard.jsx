...
const JobBoard = () => {
    ...
    // Memoize the filtered list and move searchTerm.toLowerCase() outside the filter loop
    // This prevents expensive string transformations on every iteration and avoids
    // recalculating the entire list when other state variables trigger a re-render.
    const filteredJobs = useMemo(() => {
        const lowerSearchTerm = searchTerm.toLowerCase();
        return jobListings.filter(job => {
            const matchesSearch = job.title.toLowerCase().includes(lowerSearchTerm) ||
