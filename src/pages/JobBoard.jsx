...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Memoize the filtered jobs list to prevent expensive recalculations
    // (especially the repeated .toLowerCase() calls) on every re-render unless the filter criteria change.
