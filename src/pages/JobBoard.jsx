...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Cache filtered jobs and hoist lowercase transformation outside filter loop
    // Reduces redundant computation on render and O(n) string manipulation to O(1)
