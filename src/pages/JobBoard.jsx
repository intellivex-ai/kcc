...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Hoisted searchTerm.toLowerCase() and memoized filtered jobs to prevent recalculating on every render
    const filteredJobs = useMemo(() => {
        const lowerCaseSearch = searchTerm.toLowerCase();
        return jobListings.filter(job => {
            const matchesSearch = job.title.toLowerCase().includes(lowerCaseSearch) ||
