...
const JobBoard = () => {
    ...
    // Optimization: Memoize the filtered jobs array to prevent unnecessary re-computations
    // of the entire list on every render unless the search or filter states change.
