...
const JobBoard = () => {
    ...
    // Optimize: Memoize filtered jobs and extract searchTerm.toLowerCase() out of the loop
    // to prevent expensive string operations during every re-render and array iteration.
