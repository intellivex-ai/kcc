...
const JobBoard = () => {
    ...
    const filteredJobs = useMemo(() => {
        // ⚡ Bolt: Hoisted lowercase conversion outside the filter loop to prevent redundant string allocations per item and memoized the list filtering calculation.
