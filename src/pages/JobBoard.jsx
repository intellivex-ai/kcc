...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Memoized the filtered list and hoisted the toLowerCase() computation of the search term outside the filter loop to prevent O(N) redundant string conversions on every re-render.
