...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Hoisted searchTerm.toLowerCase() outside the filter loop and memoized the calculation to prevent redundant string allocations and recalculations on every render.
