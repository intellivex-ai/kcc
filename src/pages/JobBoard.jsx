...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Memoized list filtering and hoisted the search term's lowercase transformation
    // outside the filter loop to prevent redundant calculations on every render and for every item.
