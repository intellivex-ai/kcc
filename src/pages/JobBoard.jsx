...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Hoisted searchTerm.toLowerCase() outside the filter loop and cached filtered results with useMemo to prevent redundant calculations on every render.
