...
const JobBoard = () => {
    ...
    // ⚡ Bolt: Hoisted searchTerm.toLowerCase() outside the filter loop and added useMemo
    // to prevent redundant string transformations on every render and loop iteration.
