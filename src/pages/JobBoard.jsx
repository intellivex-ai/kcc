...
const JobBoard = () => {
    ...
    // ⚡ Bolt Optimization: Memoize the filtered jobs array to prevent expensive array
    // filtering and string manipulation operations on every component re-render.
    // Expected Impact: Reduces unnecessary computations by caching the result until
    // the search term or filters change.
