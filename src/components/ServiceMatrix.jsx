                    ...
                    <div className="flex flex-wrap justify-center gap-2 lg:gap-3 mt-8 lg:mt-10">
                        {categories.map(cat => (
                            <button
                                ...
                                className={`px-4 py-2 lg:px-6 lg:py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${filter === cat
