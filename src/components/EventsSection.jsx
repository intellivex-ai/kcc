...
const EventsSection = () => {
    ...
    // ⚡ Bolt Performance Optimization: Memoize event filtering to avoid repeated expensive .toLowerCase() string transformations and array allocations on every render
