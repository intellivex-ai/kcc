      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 text-gray-900 dark:text-yellow-400 transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
          ...
          <div className="md:hidden flex items-center gap-4">
            ...
            <button
              ...
              className="text-gray-900 dark:text-white hover:text-primary p-2 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
