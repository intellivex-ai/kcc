                        ...
                        {!isPlaying ? (
                            ...
                            <div className="relative w-full h-full">
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 w-10 h-10 bg-black/50 hover:bg-black/70 rounded-full flex items-center justify-center text-white transition-colors z-10 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                                >
                                    <X size={20} />
                                </button>
                            </div>
