...
const InquiryForm = () => {
    ...
    return (
        ...
        >
            ...
            {/* Name */}
            <div className="mb-4">
                <label htmlFor="inquiry-name" className="block text-sm font-semibold text-gray-700 mb-2">Full Name *</label>
            ...
            {/* Email */}
            <div className="mb-4">
                <label htmlFor="inquiry-email" className="block text-sm font-semibold text-gray-700 mb-2">Email Address *</label>
                <div className="relative">
            ...
            {/* Phone */}
            <div className="mb-4">
                <label htmlFor="inquiry-phone" className="block text-sm font-semibold text-gray-700 mb-2">Phone Number *</label>
                <div className="relative">
            ...
            {/* Course */}
            <div className="mb-4">
                <label htmlFor="inquiry-course" className="block text-sm font-semibold text-gray-700 mb-2">Interested Course *</label>
                <div className="relative">
            ...
            {/* Message */}
            <div className="mb-6">
                <label htmlFor="inquiry-message" className="block text-sm font-semibold text-gray-700 mb-2">Message (Optional)</label>
                <div className="relative">
