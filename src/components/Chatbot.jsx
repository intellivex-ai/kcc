    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-6 right-6 z-50 bg-primary hover:bg-primary-light text-white p-4 rounded-full shadow-2xl flex items-center justify-center cursor-pointer focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            >
                    ...
                    >
                        ...
                        <form onSubmit={handleSend} className="p-3 bg-white border-t border-gray-100 flex gap-2 shrink-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                            ...
                            <button
                                ...
                                disabled={!input.trim()}
                                className="bg-primary hover:bg-primary-light disabled:opacity-50 disabled:cursor-not-allowed text-white p-2 rounded-full transition-all shadow-md active:scale-95 flex items-center justify-center w-10 h-10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                            >
